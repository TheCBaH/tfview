...
e+=b exercises in-place add_ (e is 10..15, += b of 3 -> 13..18). reshape
exercises the SymInt[] path (2x3 -> 3x2, a storage-sharing view); flatten
collapses 2x3 -> 1D [6]; avg_pool2d is a real compute kernel (1x1x4x4 of 1..16,
2x2 kernel -> the four block means 3.5/5.5/11.5/13.5).
